...
- `coral-ndarray-generation`: CORAL generic ndarray, static-object TSV, and BERVO metadata generation/validation workflow.
...
cp -R skills/coral-ndarray-generation ~/.codex/skills/
